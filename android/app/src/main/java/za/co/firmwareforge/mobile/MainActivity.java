...
public class MainActivity extends Activity implements GatewayServer.Listener {
    ...
    private void buildUi() {
        ...
        root.addView(text("FIRMWARE LIBRARY + REPORTS",11,Color.rgb(112,143,130))); firmwareInfo=text("Gateway backups are catalogued automatically in Firmware Forge Desktop 0.6 or newer. Open its Firmware Library to export the recovery BIN or download a Device Assessment PDF. You can also verify a local firmware file here.",13,Color.rgb(190,214,204)); root.addView(firmwareInfo);
